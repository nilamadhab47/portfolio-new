    ...
    >
      <RevealOnScroll>
        <div className="max-w-4xl w-full">
          ...
          <p className="text-2xl md:text-3xl text-th-text-sub font-light mb-16 max-w-2xl">
            Got a project in mind? Let's build something{" "}
            <span className="text-green-400 font-medium">awesome</span> together.{" "}
            <span className="text-th-text-dim">(Beer's on me! 🍺)</span>
          </p>
            ...
            <div>
              <div className="space-y-8">
                ...
                >
                  ...
                  <p className="text-xl md:text-2xl text-th-text hover-line group-hover:text-green-400 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-xl md:text-2xl text-th-text-muted">
              ...
              <div className="mt-12 p-6 border-2 border-green-500/30 bg-green-500/5">
                ...
                <p className="text-th-text font-bold">
                  Backend/Cloud roles, Tech Lead positions, or cool startup collaborations 🚀
                </p>
                <p className="text-th-text-muted text-sm mt-2 italic">
              ...
              {status === 'sent' ? (
                <div className="h-full flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h3 className="text-3xl font-bold text-th-text mb-3">Cheers! Message Sent!</h3>
                    <p className="text-th-text-muted">I'll get back to you faster than I finish a beer 🍺</p>
                    <button 
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="hoverable w-full bg-transparent border-b-2 border-th-border-mid px-0 py-4 text-xl text-th-text focus:outline-none focus:border-green-500 transition-colors"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="hoverable w-full bg-transparent border-b-2 border-th-border-mid px-0 py-4 text-xl text-th-text focus:outline-none focus:border-green-500 transition-colors resize-none"
          ...
          {/* Footer */}
          <div className="mt-32 pt-8 border-t border-th-border flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-th-text-faint font-mono text-sm">
              © 2026 Nilamadhab Senapati
            </p>
            <p className="text-th-text-ghost font-mono text-xs">
